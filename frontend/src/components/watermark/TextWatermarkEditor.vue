...
const systemFonts: FontOption[] = [
  ...
  { value: 'NSimSun', label: '新宋体', isSystem: true, previewFamily: '"NSimSun", serif' },
  { value: 'DengXian', label: '等线', isSystem: true, previewFamily: '"DengXian", sans-serif' },
  ...
  { value: 'STSong', label: '华文宋体', isSystem: true, previewFamily: '"STSong", serif' },
  { value: 'STHeiti', label: '华文黑体', isSystem: true, previewFamily: '"STHeiti", sans-serif' },
  { value: 'STZhongsong', label: '华文中宋', isSystem: true, previewFamily: '"STZhongsong", serif' },
  ...
  { value: 'Calibri', label: 'Calibri', isSystem: true, previewFamily: 'Calibri, sans-serif' },
  { value: 'Cambria', label: 'Cambria', isSystem: true, previewFamily: 'Cambria, serif' },
  { value: 'Segoe UI', label: 'Segoe UI', isSystem: true, previewFamily: '"Segoe UI", sans-serif' },
  { value: 'Tahoma', label: 'Tahoma', isSystem: true, previewFamily: 'Tahoma, sans-serif' },
  { value: 'Verdana', label: 'Verdana', isSystem: true, previewFamily: 'Verdana, sans-serif' },
  { value: 'Georgia', label: 'Georgia', isSystem: true, previewFamily: 'Georgia, serif' },
  { value: 'Courier New', label: 'Courier New', isSystem: true, previewFamily: '"Courier New", monospace' },
  { value: 'Consolas', label: 'Consolas', isSystem: true, previewFamily: 'Consolas, monospace' },
]
